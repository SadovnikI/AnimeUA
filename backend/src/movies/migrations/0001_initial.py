    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('bucket_id', models.ForeignKey(default=None, null=True, on_delete=django.db.models.deletion.SET_NULL, to='movies.bucket')),
            ],
            options={
                'verbose_name': 'Video',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.ForeignKey(default=None, null=True, on_delete=django.db.models.deletion.SET_NULL, to='movies.category', verbose_name='Category')),
                ('genres', models.ManyToManyField(default=None, to='movies.Genre', verbose_name='Genres')),
                ('video', models.ManyToManyField(default=None, to='movies.Video', verbose_name='Video')),
            ],
            options={
                'verbose_name': 'Movie',
